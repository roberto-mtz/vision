...
def ventana():
    ...
    b2 = Button(text='Detectar', command = boton_hoyos).pack(in_=frame, side=LEFT)
    root.mainloop()
...
def peakdet(v, delta, x = None):
    ...
    return array(maxtab), array(mintab), prueba
...
#imagen = crea_elipse(20, 100, cuantos=9, dim=250)
#imagen.save("circulo.gif")
path_imagen_original = "hoyo2.jpeg"
ventana()
